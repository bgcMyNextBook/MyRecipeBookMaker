...
namespace MyRecipeBookMaker.Converters
{
    /// <summary>
    ...
    public class BooleanToColorConverter : IValueConverter
    {
        ...
        {
            if (parameter == null || Application.Current?.Resources == null || value == null)
            {
                return Colors.Black;
            }
            ...
            switch (parameter.ToString())
            {
                ...
                case "8" when (bool)value:
                    Application.Current.Resources.TryGetValue("PrimaryColorLight", out var primary);
