...
namespace MyRecipeBookMaker
{
    ...
    {
        public ObservableCollection<MyRecipeBookMaker.Models.Review> FeedbackInfo { get; set; }

        public ObservableCollection<RatingInfo> RatingInfo { get; set; }

        public FeedbackViewModel()
        {
            FeedbackInfo = new ObservableCollection<MyRecipeBookMaker.Models.Review>();
    ...
    {
        public List<MyRecipeBookMaker.Models.Review>? FeedbackInfo { get; set; }
    }
